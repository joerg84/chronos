...
* If using the built-in CRAM-MD5 authentication mechanism, run mesos-master with the credentials flag and the path to file with authorized users + their secrets.
